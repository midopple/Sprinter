...
#define _AXIS_STEP_PER_UNIT {64, 64, 3200/1.25,774}
...
const int Z_MAX_LENGTH = 82;

//-----------------------------------------------------------------------
//// MOVEMENT SETTINGS
//-----------------------------------------------------------------------
const int NUM_AXIS = 4; // The axis order in all axis related arrays is X, Y, Z, E
#define _MAX_FEEDRATE {400, 400, 3, 45}       // (mm/sec)    
#define _HOMING_FEEDRATE {40*60,40*60,2.5*60}   // (mm/min) !!
...
#define MAX_RETRACT_FEEDRATE 45    //45 !!mm/sec
...
#define _RETRACT_ACCELERATION 2000 // 2000 !! Extruder Normal acceleration mm/s^2
